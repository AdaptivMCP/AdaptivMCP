...
_TOOL_FRIENDLY_NAMES: dict[str, str] = {
    ...
    "delete_workspace_lines": "Delete lines",
    "delete_workspace_char": "Delete characters",
    "delete_workspace_word": "Delete word",
...
def _result_snapshot(result: Any) -> dict[str, Any]:
    ...
    if isinstance(result, Mapping):
        ...
        # Streams: keep only lightweight stats here. Full clipped streams live in report["streams"].
        try:
            ...
            if isinstance(stdout, str) and stdout:
                ...
                out["stdout_chars"] = len(stdout)
            if isinstance(stderr, str) and stderr:
                out["stderr_lines"] = len(stderr.splitlines())
                out["stderr_chars"] = len(stderr)
