...
def render_detailed_tools() -> str:
    """Render the Detailed_Tools.md contents as a single string.

    This helper is used by CI/tests to ensure documentation stays in sync with
    ...
    lines.append(
        "Do not edit this file by hand. Instead, update docstrings or tool metadata and "
        "regenerate it:\n\n"
        "```bash\npython scripts/generate_detailed_tools.py\n```\n\n"
    )
...
def main_cli(argv: list[str]) -> None:
    ...
    rendered = render_detailed_tools()
