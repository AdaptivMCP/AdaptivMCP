    ...
    return {
        ...
        "expectations": {
            "assistant": [
                ...
                "Treat run_command as the way to run any project-specific or shell-level commands you would normally ask a human to run locally (linters, formatters, build scripts, migrations, one-off diagnostics), but always describe what you will run and why before you do it.",
