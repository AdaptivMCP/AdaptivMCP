...
def test_apply_patch_reports_diff_stats_and_strips_log_diff_by_default(tmp_path, monkeypatch):
...
"""
    ...
    # Client-facing responses strip __log_* fields by default.
    assert result.get("__log_diff") is None
